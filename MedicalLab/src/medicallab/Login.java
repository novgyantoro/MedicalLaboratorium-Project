...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        PasswordTb.setFont(new java.awt.Font("Trebuchet MS", 0, 12)); // NOI18N
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        if (UnameTb.getText().isEmpty() || PasswordTb.getText().isEmpty()) {
            ...
            try {
                if(UnameTb.getText().equals("kelompok3") && PasswordTb.getText().equals("kelompok3")) {
                    new Patients().setVisible(true);
                    this.dispose();
                }else{
                  JOptionPane.showMessageDialog(this, "Check your Username or Password again");
                  UnameTb.setText("");
                  PasswordTb.setText("");
                }
            } catch (Exception e) {
